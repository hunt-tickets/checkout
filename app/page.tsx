    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
              Todos los métodos de pago <span className="inline-block">que aman 💕</span> tus clientes
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Apple Pay, Google Pay, Nequi, PSE y todas las tarjetas de crédito y débito
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-10">
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <span className="text-sm font-medium text-gray-600">Apple Pay</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-3">
              <div className="w-20 h-20 bg-white rounded-2xl flex items-center justify-center shadow-lg border border-gray-100">
                <span className="text-[#1A1F71] font-bold text-2xl italic">VISA</span>
              </div>
          ...
          <p className="text-center text-gray-500 mt-10">
            Y muchos más: American Express, Diners Club, tarjetas débito de todos los bancos colombianos
          </p>
        </div>
      </section>
